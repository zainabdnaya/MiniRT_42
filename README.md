...
## What's Raytraicng?!
    ...
    <br> Essentially, an algorithm can trace the path of light, <\br>
    <br> and then simulate the way that the light interacts with the virtual objects it ultimately hits in the computer-generated world. <\br>
